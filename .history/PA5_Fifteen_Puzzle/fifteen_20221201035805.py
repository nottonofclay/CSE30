...
class Fifteen:
    ...
    def draw(self):
        ...
        print('+----+----+----+----+')
        print('| {} | {} | {} | {} |'.format(board_vals[0], board_vals[1],  board_vals[2],  board_vals[3], fill=' ',width=2))
        print('+----+----+----+----+')
        print('| {} | {} | {} | {} |'.format(board_vals[4], board_vals[5],  board_vals[6],  board_vals[7], fill=' ',width=2))
        print('+----+----+----+----+')
        print('| {} | {} | {} | {} |'.format(board_vals[8], board_vals[9],  board_vals[10], board_vals[11], fill=' ',width=2))
        print('+----+----+----+----+')
        print('| {} | {} | {} | {} |'.format(board_vals[12],board_vals[13], board_vals[14], board_vals[15], fill=' ',width=2))
        print('+----+----+----+----+')
